(this.webpackJsonptest = this.webpackJsonptest || []).push([[0], {
    ...
    39: function (e, n, t) {
        ...
        var f = function () {
            var e;
            return null !== (e = JSON.parse(localStorage.getItem(d))) && void 0 !== e ? e : v({}, h)
        }();

        function v(e, n) {
            var t;
            for (var a in e = null !== (t = e) && void 0 !== t ? t : {}, n) {
                var o;
                if (Array.isArray(n[a])) e[a] = null !== (o = e[a]) && void 0 !== o ? o : [], b(e[a], n[a]);
                else if (null === n[a]) {
                    var r;
                    e[a] = null !== (r = e[a]) && void 0 !== r ? r : n[a]
                } else if ("object" === typeof n[a]) e[a] = v(e[a], n[a]);
                else {
                    var i;
                    e[a] = n[a].constructor(null !== (i = e[a]) && void 0 !== i ? i : n[a])
                }
            }
            return e
        }
        ...
        var g = t(20),
            ...
            A = function () {
                ...
                return Object(w.a)(e, [{
                    ...
                    key: "effectMultiply",
                    value: function (e) {
                        return "function" === typeof this._effectMultiply ? this._effectMultiply(e) : 1
                    }
                }, {
                    key: "cost",
                    value: function (e, n) {
                        ...
                        for (var a in t = "function" === typeof this._cost ? this._cost(e) : this._cost, t) t[a] = Math.ceil(t[a]), t[a] <= 0 && delete t[a];
                        return t
                    }
                }]), e
            }(),
            O = {
                ...
                Stone: new A({
                    ...
                    effectMultiply: function (e) {
                        return Math.pow(e[O.Pickaxe.order].have, 1.3)
                    },
                    unlockAt: {
                        Pickaxe: 1
                    },
                ...
                ShinyStone: new A({
                    ...
                    effectMultiply: function (e) {
                        var n = 1;
                        return n *= e[O.GemstonePickaxe.order].have, n *= 1 + e[O.GemBoost.order].have / 3
                    },
                    unlockAt: {
                        GemstonePickaxe: 1
                    },
                ...
                Generator: new A({
                    ...
                    craftTime: 100,
                    effectMultiply: function (e) {
                        return Math.pow(4, e[O.GeneratorBoost.order].have)
                    },
                    automates: ["Energy"],
                    unlockAt: {
                        Citizen: 1
                ...
                Pickaxe: new A({
                    ...
                    effectMultiply: function (e) {
                        var n = 1;
                        return n *= e[O.GemstonePickaxe.order].have + 1, n *= e[O.PickaxeUpgrade.order].have / 3 + 1
                    },
                    unlockAt: {
                        Plank: 1
                    },
                ...
                GemstonePickaxe: new A({
                    ...
                    effectMultiply: function (e) {
                        var n = 1;
                        return n *= e[O.PickaxeUpgrade.order].have / 3 + 1
                    },
                    unlockAt: {
                        Emerald: 1
                    },
                ...
                Pump: new A({
                    ...
                    automates: ["Water"],
                    effectMultiply: function (e) {
                        return e[O.LiquidBoost.order].have / 3 + 1
                    },
                    unlockAt: {
                        Copper: 1
                    },
                ...
                MetalworkFactory: new A({
                    ...
                    effectMultiply: function (e) {
                        return e[O.MetalworkBoost.order].have / 3 + 1
                    },
                    unlockAt: {
                        Pump: 1,
                        Volcano: 1
                ...
                DivinePowder: new A({
                    ...
                    cost: function (e) {
                        return {
                            Replicanti: Math.pow(10, Math.pow(e / 5, .9) + 6),
                            Energy: 100 + Math.pow(e, 2),
                            Sapphire: 1 + Math.pow(e / 10, .2)
                        }
                    },
                    craftTime: 3,
                    unlockAt: {
                ...
                Replicanti: new A({
                    ...
                    craftMultiply: 2,
                    effectMultiply: function (e) {
                        var n = e[O.Replicanti.order].have,
                            t = e[O.ReplicantiBoost.order].have,
                            a = .6 + .35 * (1 - 1 / (t / 30 + 1));
                        return Math.pow(1.5, t + 1) * Math.pow(n + 1, a) / (n + 1)
                    },
                    unlockAt: {
                        Replicanti: 1
                    },
        ...
        function x(e, n) {
            ...
            if (null === n.resources[t.order].startTime) {
                var a = t.cost(n.resources[t.order].have),
                    o = 1 / 0;
                if (null === a) return o;
                for (var r in a) {
                    var i = a[r],
                        c = n.resources[C(r).order].have;
                    if (i > c) return !1;
                    o = Math.min(o, c / i)
                }
                return Math.floor(o)
        ...
        function R(e, n) {
            var t = O[e],
                a = t.order,
                o = 1e3 * t.craftTime;
            return -1 !== j[a] && (o /= Math.max(1, n.resources[j[a]].have), o /= M[j[a]].effectMultiply(n.resources)), o
        }

        function T(e, n) {
            var t = O[e];
            if (!t || !t.unlockAt) return !1;
            for (var a in t.unlockAt)
                if (n[O[a].order].have < t.unlockAt[a]) return !1;
            return !0
        }
        var E = "resource/CRAFT_START",
            G = "resource/CRAFT_UPDATE",
            B = "resource/RESOURCE_UNLOCK",
        ...
        function D(e, n) {
            ...
            for (var o in n) {
                var r = n[o],
                    i = O[o].order;
                a = Math.min(a, e[i].have / r)
            }
            if ((a = Math.floor(a)) <= 0) return !1;
            for (var c in n) {
                var l = n[c],
                    s = O[c].order;
        ...
        var Q = function () {
                ...
                var a = n.order,
                    o = e[a].have,
                    r = !e[a].automationDisabled && n.isAuto,
                    i = t.cost(o, r);
                switch (n.type) {
                    case E:
                        if (null !== (e = Object(m.a)(e))[a].lastTime) return e;
                        var c = D(e, i, 1);
                        return c ? (e[a] = Object(p.a)(Object(p.a)({}, e[a]), {}, {
                            lastTime: (new Date).getTime(),
                            progress: 0
                        }), e) : (0 !== e[a].progress && (e[a] = Object(p.a)(Object(p.a)({}, e[a]), {}, {
                            progress: 0
                        })), e);
                    case G:
                        if ((e = Object(m.a)(e))[a] = Object(p.a)(Object(p.a)({}, e[a]), {}, {
                                lastTime: n.Time,
                                progress: e[a].progress + n.progressIncrement
                            }), e[a].progress >= 1) {
                            e[a].lastTime = null;
                            var l = 1;
                            r ? (l += D(e, i, Math.floor(e[a].progress) - 1), e[a].have += l * t.craftMultiply, e[a].progress %= 1) : (e[a].have += t.craftMultiply, e[a].progress = 0);
                            for (var s = t.effectMultiply(e), d = 0; d < t.randomGrantOnCraft.length; d++) {
                                var h = Object(u.a)(t.randomGrantOnCraft[d], 2),
                                    v = h[0],
                                    b = h[1],
                                    g = v * s,
                                    w = 1 - Math.pow(1 - Math.min(1, g), l),
                                    A = l * w > 5 || w >= .99 ? Math.round(l * g) : +(Math.random() < w);
                                A >= 1 && (e[O[b].order] = Object(p.a)(Object(p.a)({}, e[O[b].order]), {}, {
                                    have: e[O[b].order].have + A
                                }))
                            }
                        }
                        return e;
                    case B:
                        return (e = Object(m.a)(e))[a] = Object(p.a)(Object(p.a)({}, e[a]), {}, {
                            unlocked: !0
                        }), e;
                    case z:
                        return (e = Object(m.a)(e))[a] = Object(p.a)(Object(p.a)({}, e[a]), {}, {
                            automationDisabled: !e[a].automationDisabled
                        }), e;
                    default:
                        return e
                }
        ...
        var te, ae, oe, re, ie = function (e) {
                var n = e.Resource;
                return e.save, Object(V.jsx)(V.Fragment, {
                    children: n.automates && n.automates.length > 0 && Object(V.jsxs)(ne, {
        ...
        var me, pe, de, he, fe, ve = Object(c.b)((function (e) {
                return {
                    save: e.resources
                }
            }), {
                ...
                var n = e.Resource,
                    t = e.save,
                    a = n ? n.effectMultiply(t) : 1,
                    o = n.randomGrantOnCraft.map((function (e) {
                        return [Math.min(1, e[0] * a), e[1]]
                    }));
                return 0 !== o.length || 1 !== a ? Object(V.jsxs)(ce, {
                    children: [Object(V.jsx)(le, {
                        ...
                        children: o.map((function (e) {
                            ...
                            return Object(V.jsxs)(ue, {
                                children: [t[r.order].unlocked ? Object(V.jsx)(X, {
                                    size: "var(--itemHeight)",
                                    position: r.position
                                }) : Object(V.jsx)("span", {
                                    children: "?\xa0"
                                }), Object(V.jsxs)("span", {
                                    children: [(100 * a).toFixed(2).padStart(6, "0"), "%"]
                                })]
                            }, r.name)
                        }))
                    })]
        ...
        var Me, ye, Se, ke = Object(c.b)((function () {
                ...
                var n, t = e.Resource,
                    ...
                    p = m[0],
                    d = m[1],
                    h = t ? t.name.replace(/(.)([A-Z])/g, "$1 $2") : "",
                    f = Object(c.c)((function (e) {
                        return e.resources[o]
                    })),
                    v = t ? Object.entries(null !== (n = t.cost(f.have)) && void 0 !== n ? n : {}) : [],
                    b = j[o],
                    g = f.unlocked && (!i || -1 !== b);
                return Object(V.jsx)(ge, {
                    onClick: function () {
                        var e;
                        i ? l(o) : t && 0 !== Object.keys(null !== (e = t.cost(f.have)) && void 0 !== e ? e : {}).length && r(o)
                    },
                    ...
                    name: cnItem(h),
                    style: {
                        backgroundColor: f.automationDisabled || i && g ? f.automationDisabled ? "#541212" : "#1c5412" : void 0,
                        opacity: g ? void 0 : .3,
                        pointerEvents: g ? void 0 : "none"
                    },
                    children: g && t && Object(V.jsxs)(we, {
                        children: [Object(V.jsxs)("span", {
                            children: [Object(V.jsx)(X, {
                                ...
                                style: {
                                    height: "".concat(100 * f.progress, "%")
                                }
                            })]
                        }), p && Object(V.jsxs)(V.Fragment, {
        ...
        var Re, Te, Ee = function (e) {
                ...
                return Object(V.jsxs)(V.Fragment, {
                    children: [Object(V.jsx)(je, {
                        onClick: Object(a.useCallback)((function () {
                            i(!r)
                        }), [r]),
                        style: {
                            backgroundColor: r ? "var(--colAlt1)" : void 0,
                            color: r ? "var(--colMain1)" : void 0
                        },
                        children: "Toggle Auto"
                    }), Object(V.jsx)(Ce, {
                        children: M.map((function (e, t) {
                            return Object(V.jsx)(ke, {
                                Resource: e,
                                autoToggleMode: r,
                                index: t,
                                craftStart: n
                            }, null !== e ? e.name : "empty_".concat(t))
                        }))
                    }), Object(V.jsx)(xe, {
                        children: "- Nothing -"
                    })]
        ...
        var ze = function () {
                return Object(V.jsxs)("div", {
                    className: "App",
                    children: [Object(V.jsx)(Ge, {}), Object(V.jsxs)(Be, {
                        children: [!1, Object(V.jsx)(Ee, {})]
                    })]
                })
            },
            Ie = function (e) {
                e && e instanceof Function && t.e(3).then(t.bind(null, 40)).then((function (n) {
                    var t = n.getCLS,
                        a = n.getFID,
                        o = n.getFCP,
                        r = n.getLCP,
        ...
        var We = function () {
            ...
            for (var t = 0; t < M.length; t++) {
                ...
                if (null !== o) {
                    var r = t,
                        i = e.resources[r],
                        c = 1 <= (null === (a = e.resources[j[r]]) || void 0 === a ? void 0 : a.have);
                    if (!i.unlocked && (i.have >= 1 || T(o.name, e.resources)) && De.dispatch(P(r)), o.automates && i.have >= 1)
                        for (var l = 0; l < o.automates.length; l++) {
                            var s = O[o.automates[l]],
                                u = s.order;
                            null !== e.resources[u].lastTime || 0 === x(s.name, e) || e.resources[u].automationDisabled || De.dispatch(I(u, !0))
                        }
                    var m = i.lastTime;
                    if (null !== m) {
                        var p = (n - m) / R(o.name, e) * 1;
                        De.dispatch(F({
                            order: t,
                            isAuto: c,
                            Time: n,
        ...
        i.a.render(Object(V.jsx)(o.a.StrictMode, {
            children: Object(V.jsx)(c.a, {
                store: De,
                children: Object(V.jsx)(ze, {})
            })
